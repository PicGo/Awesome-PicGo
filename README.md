...
| [picgo-plugin-avif](https://github.com/kyo-tom/picgo-plugin-immich-uploader)           | Convert images to avif format before uploading for better web distribution. 图像上传前转换为avif格式，实现更好地网页分发     | :white_check_mark: | :white_check_mark: |
